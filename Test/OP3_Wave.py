...
robot = p.loadURDF("D:/python/Pycharm/Test/robotis_op3.urdf", op3StartPos, op3StartOrientation)
circleStartPos = [0.14820810926653658, 0.11138307132884889, 0.32432147609577605]
circle = p.loadURDF("D:/python/Pycharm/Test/ball.urdf", circleStartPos)
